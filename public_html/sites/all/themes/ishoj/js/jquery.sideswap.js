...
{					
	$.fn.sideswap = function(options)
	{
		$.fn.sideswap.defaults = 
		{
			...
			previous: ' ', /* HTML TO BE USED FOR THE PREVIOUS ARROW */
			next: ' ', /* HTML TO BE USED FOR THE NEXT ARROW */
			display_time: 8000, /* NUMBER OF 1/1000 SECONDS AN IMAGE IS DISPLAYED - default: 5000*/
			/*transition_speed: 2000,*/ /*200,*/ /* SPEED OF TRANSITIONS IN 1/1000 SECONDS */
			duration: 1,
